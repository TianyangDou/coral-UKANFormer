...
class UKAN(nn.Module):
    def __init__(
        ...
        **kwargs,
        ...
        self.decoder3 = Decoder_ConvLayer(embed_dims[0], embed_dims[0] // 2)
        self.decoder4 = Decoder_ConvLayer(embed_dims[0] // 2, embed_dims[0] // 4)
        self.decoder5 = Decoder_ConvLayer(embed_dims[0] // 4, embed_dims[0] // 4)
